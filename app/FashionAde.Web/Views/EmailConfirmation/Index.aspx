...
<div class="parentDiv">
    <div class="divContainer" style="width: 670px; float: left; padding:20px 0 40px 20px; margin-bottom:20px;">
        <span style="font-size:16px;">We have sent a confirmation email to your email adress.</span>
        <h3 style="margin:0;">Click on the link or copy and paste your code in this box:</h3>
        <br />
