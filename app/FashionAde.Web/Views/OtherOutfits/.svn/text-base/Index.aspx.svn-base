...
<div style="width: 710px; float: left; margin-right:5px;">
    ...
    <div class="publicClosetQuestions" style="margin-right:10px;">
        Want to reciprocate but don’t see your Closet?  <%= Html.ActionLink("Update your profile now", "Index", "Account", null, new { style = "display:inline;" })%>  to share some inspiration of your own.<br />
        
    </div>
    
    <div class="publicClosetQuestions">
        Don’t have a Closet of your own yet?<br />
        <%= Html.ActionLink("Build one now.", "Index", "Home", null, null)%>
    </div>
