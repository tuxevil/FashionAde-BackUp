    ...
    <div style="width: 690px; float: left;">
        ...
        <% if (!Model.ForEdit)
           {%>
            ...
            <h2 style="float:left; color:#000; margin:0 0 10px 0;">Just click on a garment, choose it in the color you own and drag that piece into your closet. <br /> Yes, it’s that easy!</h2>
        <%}
           else
           { %>
