...
<div class="OutfitDiv" id="<%= "div_" + Model.Id  %>">
    ...
    <div class="outfitUpdater">
       ...
       { %>
        <a class="divButton addThis" target="_blank" style="width: 50px; text-align: center;" href="http://www.kqzyfj.com/click-3636043-10273706?url=http%3A%2F%2Fwww.zappos.com%2Fn%2Fredirect.cgi%3Fq%3Dvz361022560z2%26zcj%3D1" >BUY</a>
        <div class="Outfit_Result_Garment" style="margin: 5px 0px 15px 5px;">            
            <a href="http://www.kqzyfj.com/click-3636043-10273706?url=http%3A%2F%2Fwww.zappos.com%2Fn%2Fredirect.cgi%3Fq%3Dvz361022560z2%26zcj%3D1" target="_blank">
                <img class="OutfitUpdaterImg" src="http://www.zappos.com/images/z/1/0/8/1087421-t-THUMBNAIL.jpg" alt="Dakine - Kate (Westwood Plaid/Navy) - Bags and Luggage $31" title="Dakine - Kate (Westwood Plaid/Navy) - Bags and Luggage $31" />
            </a><br />
            <span>Zappos.com</span><br />
            <span style="color: black; font-weight: normal;">$31.00</span><br />
        </div>
        <%} %>
    </div>
